...
<p>[php]class cache extends acm[/php]</p>
<p>Substituidlo por:</p>
<p>[php]class fcache extends acm[/php]</p>
...
<p>[php]new cache();[/php]</p>
<p>Y reemplazadlo por:</p>
<p>[php]new fcache();[/php]</p>
...
<p>[php]class user extends session[/php]</p>
<p>Y reemplazadlo por...</p>
<p>[php]class fuser extends session[/php]</p>
<p>Ahora abrid el fichero <em>phpBB3/common.php</em> y buscad lo siguiente:</p>
<p>[php]new user();[/php]</p>
<p>Y reemplazadlo por:</p>
<p>[php]new fuser();[/php]</p>
...
<p>[php]&lt;?php // /app/views/users/login.ctp<br />
...
<p>[sourcecode language="plain"]; The path for which the cookie is valid.<br />
